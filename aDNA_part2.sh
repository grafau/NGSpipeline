...
#SBATCH -t 0-24:00:00
#SBATCH -o /data/users_area/yky10kg/GREENrice/Cons_Gen/pipeline_testing/aDNA4/a_read_processing_part2_%A_%a.log
#SBATCH -e /data/users_area/yky10kg/GREENrice/Cons_Gen/pipeline_testing/aDNA4/a_read_processing_part2_%A_%a.err
#SBATCH --array=1-ARRAY_SIZE
#SBATCH --dependency=afterok:<part1_job_id>
